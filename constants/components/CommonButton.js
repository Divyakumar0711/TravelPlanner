...
export default CommonButton = props => (
  <TouchableWithoutFeedback
    ...
    <View style={{ alignItems: 'center', justifyContent: 'center', marginTop: props.marginTop, width: props.width, marginLeft: props.marginLeft, marginRight: props.marginRight, backgroundColor: props.backgroundColor, height: props.height, borderRadius: props.borderRadius, borderColor:props.borderColor,borderWidth:props.borderWidth }}>
